# RailsAdmin config file. Generated on October 05, 2012 16:01
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ecn', 'Admin']
  ...
  # config.excluded_models = ['Company', 'Kv', 'Product', 'Role', 'Topic', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Company', 'Kv', 'Product', 'Role', 'Topic', 'User']
  ...
  #     configure :opera_address, :string 
  #     configure :zip, :string 
  #     configure :phone, :string 
  #     configure :mobile, :string 
  #     configure :fax, :string 
  #     configure :website, :string 
  #     configure :aliexpress, :string 
  #     configure :email, :string 
  #     configure :btypes, :string 
  #     configure :main_products, :string 
  #     configure :contact, :string 
  #     configure :trackback, :string 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your kv.rb model definition
  ...
  #     configure :name, :string 
  #     configure :slug, :string 
  #     configure :products_count, :integer 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
